...
// Retorno: nenhum
//-----------------------------------------------------------------------------------------------------------
function validarProduto(idNomeProduto, idCodProduto, idQtidadeProduto, idValidade) {
    ...
    let validade = document.getElementById(idValidade).value;
    ...
    else cadastrarProduto(nome, codigo, parseInt(qtidade), validade);
}
//-----------------------------------------------------------------------------------------------------------
...
// Retorno: nenhum
//-----------------------------------------------------------------------------------------------------------
function cadastrarProduto(produto, codig, qtidade, validade) {
    let novoProduto = {nome:produto, codigo:codig, quantidade:qtidade, validade:validade};
    ...
    if (typeof(Storage) !== "undefined") {
        ...
        if (produtos == null)
            ...
            produtos.forEach(produto => {
                ...
                document.write("<li>Validade do Produto: "+produto.validade+"</li>");
                document.write("</ul>");
            });
        }
    } 
